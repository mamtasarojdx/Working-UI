        ...
        <div className="container">
          <div className="row d-flex mt-4 mb-4">
            ...
            <div className="col-lg-4 col-md-4 col-sm-4 d-flex">
              <h5 className="d-flex">
                <input type="text" placeholder="Search id" className="crud-search" onChange={handleSearch}></input>
                <input type="text" placeholder="Search name" className="crud-search " onChange={handleSearch}></input>
                <input type="text" placeholder="Search page" className="crud-search " onChange={handleSearch}></input>
              </h5>
            </div>
        ...
        <div>
          <table className=" table table-striped">
            ...
            <tbody>
                  ...
                  {searchText==searchText2==searchText3 ? filteredArray.map((item) => (
                        <tr key={item.id}>
                          <td>{item.id}</td>
                          <td>{item.name}</td>
                          <td>{item.email}</td>
