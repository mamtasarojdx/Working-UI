  ...
  <AiOutlineSearch />
      ...
      <hr className="news-hr" />
        <div className="text-center">
          ...
          <input type="text" placeholder="Enter Your Email Address" className="mail_1 mb-3"></input> <br />
          <input type="submit" value="SUBSCRIBE!" className="btn_1 mb-5"></input>
        </div>

        <div className="container d-flex justify-content-center align-items-center mb-4 input-para">
