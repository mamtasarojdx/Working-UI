  ...
  return (
    <div>
      ...
      <div className="home1 mt-4" style={{ color: "grey", fontSize: "10px" }}>
        <p className="home1">Home / Contact</p>
      </div>

      {/* -----contact content----- */}
      <div className="container contact-part">
        <div className="row">
          <div className="col-lg-4 col-md-4 col-sm-4 mt-1">
            <h3 className="mb-4">Here to Help</h3>
            <p className="contact-para">Have a question? You may find an answer in our FAQs. But you can also contact us:</p>
            <div className="contact-para1">CALL US: 800-123-4567</div>
            <div className="contact-para1">747 MADISON AVENUE, NEW YORK, NY 10065</div>
            <ul className="list-unstyled contact-para2 mt-4 mb-4">
              <li>Opening Hours:</li>
              <li>Monday to Friday 9:00 am - 6:00 pm</li>
              <li>Saturday 9:00 am - 4:00 pm</li>
              <li>Sunday: 9 pm - 2:00 pm</li>
            </ul>
            <img src="Location.webp" className="location-img"></img>
          </div>
          <div className="col-lg-8 col-md-8 col-sm-8">
            <h3>Drop Us A Line</h3>
            <p className="contact-para2 mt-4">
              We’re happy to answer any questions you have or provide you with an estimate. Just send us a message in the form below with any questions you may
              have.
            </p>
            <form>
              <label className="contact-label">NAME(required)*</label>
              <br />
              <input type="text" placeholder="Enter please your name" className="mb-3 contact-input1"></input>
              <br />
              <label className="contact-label">EMAIL (required)</label>
              <br />
              <input type="text" placeholder="Enter please your email address" className="mb-3 contact-input1"></input>
              <br />
              <label className="contact-label">PHONE NUMBER</label>
              <br />
              <input type="text" placeholder="Enter please your phone number" className="mb-3 contact-input1"></input>
              <br />
              <label className="contact-label">YOUR MESSAGE (required)*</label>
              <br />
              <textarea type="text" placeholder="Enter please your message" className="mb-3 contact-input2"></textarea>
              <div class="pt-10">
                <button type="submit" class="btn btn--secondary contact-submit">
                  <span>
                    <BsChatLeftHeart />
                  </span>{" "}
                  SUBMIT
