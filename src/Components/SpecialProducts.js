...
import Special_Products2 from "./Special_Products2";
...
function SpecialProducts() {
  ...
  return (
    <>
      {/* ------Special Products Featured Products(3rd raw)------- */}

      <div className="container special-product1">
        <div className="d-flex justify-content-center align-items-center">
          <div onClick={() => IsActive(1)} style={active === 1 ? { color: "#ff751d" } : { color: "black" }}>
            {" "}
            <h3 className="head1 mt-5 mb-5 fw-bold ">New Products </h3>
          </div>
          <div onClick={() => IsActive(2)} style={active === 2 ? { color: "#ff751d" } : { color: "black" }}>
            <h3 className="head2 mt-5 mb-5 fw-bold "> Special Products </h3>
          </div>
          <div onClick={() => IsActive(3)} style={active === 3 ? { color: "#ff751d" } : { color: "black" }}>
            <h3 className="head2 mt-5 mb-5 fw-bold "> Featured Products</h3>
          </div>
        </div>
        <div>
          {active == 1 && (
            <>
              <div className="row d-flex" style={{ color: "black", animationDuration: "0.4s" }}>
                <div className="col-lg-4 col-xxl-3 col-xl-4  col-md-4 col-sm-6 mt-4 mb-3">
                    ...
                    {isHovered ? (
                      <div className="cont">
                        ...
                        <div className="overlay">
                          ...
                          <div className="hover-icon2">
                            <span>
                              <AiOutlineLeft className="hover-left" />
                            </span>
                            <span>
                              <AiOutlineRight className="hover-right" />
                            </span>{" "}
                          </div>
                        </div>
                      </div>
                  ...
                  <div className="image-content2">
                    <div className="text-start mt-3 mb-2">
                      <div style={{ fontSize: "13px" }}>CORSAIR - Desktop Memory Kit</div>
                      <div style={{ color: "black", fontWeight: "bolder" }}>$80.00</div>
                    </div>
                    <div className="d-flex">
                      <button className="cart-btn mt-2 mb-5">
                        {" "}
                        <span>
                      ...
                      <div className="special-icons2 mt-3 mb-5 mx-3">
                        <AiOutlineHeart style={{ fontSize: "20px" }} className="heart-2" />
                        <i class="fa fa-balance-scale mx-3" style={{ fontSize: "20px" }} id="balance-icon2"></i>
                      </div>
                    </div>
                  </div>
              ...
              <div className="d-flex cart-icons">
                ...
                <div className="col-lg-4 col-xxl-3 col-xl-4  col-md-4 col-sm-6 mt-4 mb-3">
                  ...
                  <div className="image-content2">
                    <div className="text-start mt-3 mb-2">
                      <div style={{ fontSize: "13px" }}>Dell - S2419NX 24 IPS LED Monitor</div>
                      <div style={{ color: "black", fontWeight: "bolder" }}>$100.00</div>
                    </div>
                    <div className="d-flex">
                      <button className="cart-btn mt-2 mb-5">
              ...
              <div className="d-flex cart-icons">
                ...
                <div className="col-lg-4 col-xxl-3 col-xl-4  col-md-4 col-sm-6 mt-4 mb-3">
                  ...
                  <div className="image-content2">
                    <div className="text-start mt-3 mb-2">
                      <div style={{ fontSize: "13px" }}>CORSAIR - ATX Mid-Tower Case</div>
              ...
              <div className="d-flex cart-icons">
                ...
                <div className="col-lg-4 col-xxl-3 col-xl-4  col-md-4 col-sm-6 mt-4 mb-3">
                  ...
                  <div className="image-content2">
                    <div className="text-start mt-3 mb-2">
                      <div style={{ fontSize: "13px" }}>Linksys - Tri-Band Mesh WiFi 5 Router</div>
              ...
              <div className="d-flex cart-icons">
                ...
                <div className="col-lg-4 col-xxl-3 col-xl-4  col-md-4 col-sm-6 mt-4 mb-3">
                  ...
                  <div className="image-content2">
                    <div className="text-start mt-3 mb-2">
                      <div style={{ fontSize: "13px" }}>CORSAIR - Liquid Cooling System</div>
              ...
              <div className="d-flex cart-icons">
                ...
                <div className="col-lg-4 col-xxl-3 col-xl-4  col-md-4 col-sm-6 mt-4 mb-3">
                  ...
                  <div className="image-content2">
                    <div className="text-start mt-3 mb-2">
                      <div style={{ fontSize: "13px" }}>MSI - GAMING PRO Intel Motherboard</div>
          ...
          {active == 2 && (
            <>
              <div className="row d-flex" style={{ color: "black" }}>
                  ...
                  <div className="col-lg-4 col-xxl-3 col-xl-4  col-md-4 col-sm-6 mt-4 mb-3">
                    ...
                    <div className="image-content2">
                      <div className="text-start mt-3 mb-2">
                        <div style={{ fontSize: "13px", fontWeight: "100" }}>Apple - MacBook Air 13.3 - Gold</div>
              ...
              <div className="d-flex cart-icons">
                ...
                <AiOutlineEye style={{ fontSize: "20px" }} className="eye-icon" />
                  ...
                  <div className="col-lg-4 col-xxl-3 col-xl-4  col-md-4 col-sm-6 mt-4 mb-3">
                    ...
                    <div className="image-content2">
                      <div className="text-start mt-3 mb-2">
                        <div style={{ fontSize: "13px", fontWeight: "100" }}>CORSAIR - ATX Mid-Tower Case</div>
              ...
              <div className="d-flex cart-icons">
                ...
                <AiOutlineEye style={{ fontSize: "20px" }} className="eye-icon" />
                  ...
                  <div className="col-lg-4 col-xxl-3 col-xl-4  col-md-4 col-sm-6 mt-4 mb-3">
                    ...
                    <div className="image-content2">
                      <div className="text-start mt-3 mb-2">
                        <div style={{ fontSize: "13px", fontWeight: "100" }}>CORSAIR - Liquid Cooling System</div>
              ...
              <div className="d-flex cart-icons">
                ...
                <AiOutlineEye style={{ fontSize: "20px" }} className="eye-icon" />
                  ...
                  <div className="col-lg-4 col-xxl-3 col-xl-4  col-md-4 col-sm-6 mt-4 mb-3">
                    ...
                    <div className="image-content2">
                      <div className="text-start mt-3 mb-2">
                        <div style={{ fontSize: "13px", fontWeight: "100" }}>Dell - S2419NX 24 IPS LED Monitor</div>
              ...
              <div className="d-flex cart-icons">
                ...
                <AiOutlineEye style={{ fontSize: "20px" }} className="eye-icon" />
                  ...
                  <div className="col-lg-4 col-xxl-3 col-xl-4  col-md-4 col-sm-6 mt-4 mb-3">
                    ...
                    <div className="image-content2">
                      <div className="text-start mt-3 mb-2">
                        <div style={{ fontSize: "13px", fontWeight: "100" }}>CORSAIR - Desktop Memory Kit</div>
                ...
                <AiOutlineEye style={{ fontSize: "20px" }} className="eye-icon" />
                  ...
                  <div className="col-lg-4 col-xxl-3 col-xl-4  col-md-4 col-sm-6 mt-4 mb-3">
                    <div onMouseEnter={handleHover6} onMouseLeave={handleHover6}>
                      {isHovered6 ? (
                        <img
                          src="https://shella-computers.myshopify.com/cdn/shop/products/5_338x.progressive.jpg?v=1570203583"
                          alt="Hovered Image"
                          className="special-image6"
                        />
                      ) : (
                        <img src="https://shella-computers.myshopify.com/cdn/shop/products/5-1_338x.jpg" alt="Original Image" className="special-image6" />
                      )}
                    </div>

                    <div className="image-content2">
                      <div className="text-start mt-3 mb-2">
                        <div style={{ fontSize: "13px", fontWeight: "100" }}>Epson - EcoTank Wireless Printer</div>
              ...
              <div className="d-flex cart-icons">
                ...
                <AiOutlineEye style={{ fontSize: "20px" }} className="eye-icon" />
                  ...
                  <div className="col-lg-4 col-xxl-3 col-xl-4  col-md-4 col-sm-6 mt-4 mb-3">
                    ...
                    <div className="image-content2">
                      <div className="text-start mt-3 mb-2">
                        <div style={{ fontSize: "13px", fontWeight: "100" }}>Linksys - Tri-Band Mesh WiFi 5 Router</div>
              ...
              <div className="d-flex cart-icons">
                ...
                <AiOutlineEye style={{ fontSize: "20px" }} className="eye-icon" />
                  ...
                  <div className="col-lg-4 col-xxl-3 col-xl-4  col-md-4 col-sm-6 mt-4 mb-3">
                    ...
                    <div className="image-content2">
                      <div className="text-start mt-3 mb-2">
                        <div style={{ fontSize: "13px", fontWeight: "100" }}>MSI - GAMING PRO Intel Motherboard</div>
