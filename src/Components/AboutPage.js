  ...
  return (
    <div>
      ...
      <div className="home1 mt-4" style={{ color: "grey", fontSize: "10px" }}>
        <p className="home1">Home / About our store</p>
      ...
      <div className="container">
        <div className="row">
          <div className="col-lg-12 col-md-12 col-sm-12 d-flex">
            <img src="https://cdn.shopify.com/s/files/1/0026/2956/6516/files/about-page_1024x1024.jpg?v=1534148466" className="about-img"></img>
          </div>
        </div>
      </div>
      ...
      <div className="container w-100 text-center ">
        <p className="mt-5 mb-5" style={{ color: "grey", fontSize: "14px" }}>
          A great About Us page helps builds trust between you and your customers. The more content you provide about you and your business, the more confident
          people will be when purchasing from your store.
        </p>
        <p className="mt-5 mb-5">
          <img src="https://cdn.shopify.com/s/files/1/0026/2956/6516/files/blogs-about_large.png?v=1533265367" className="annie-img"></img>
        </p>
        <hr className="annie-hr" />
      </div>

      {/* --------input filed and content */}
